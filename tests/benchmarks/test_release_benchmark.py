...
def test_release_benchmark_writes_release_bundle(tmp_path):
    report = run_release_benchmark(ReleaseConfig(synthetic_rows=180, scale_sizes=(300,), output_dir=tmp_path, benchmark_models=("S-Learner", "DR-Learner", "CausalForestDML")))
