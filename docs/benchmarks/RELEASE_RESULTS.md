...
- Run: `20260903T172512Z-42`; commit: `103f8389991a8c79599287dc16a9b0d9bf012bd6`.
...
- Scale: 10K `4.89s`, 100K `40.93s`, 1M `489.90s`; 1M peak process RSS was
  `1619.3MB`. These are measured local runs, not extrapolations.
