...
def optional_backend_status(model_name: str, model_info: dict[str, Any], result_rows: list[dict[str, Any]]) -> str:
    ...
    if matching and matching[0].get("status") == "PASS":
        return "PASS"
    return "FAIL" if model_info.get("runnable") else "INTERFACE_ONLY"


def build_release_gate(*, synthetic_pass: bool, observational_pass: bool, application_pass: bool, rct_pass: bool, multi_pass: bool, continuous_pass: bool, scale_results: list[dict[str, Any]], hillstrom_status: str, criteo_status: str, reproducibility_pass: bool, packaging_pass: bool, ci_pass: bool, optional_statuses: dict[str, str]) -> dict[str, Any]:
